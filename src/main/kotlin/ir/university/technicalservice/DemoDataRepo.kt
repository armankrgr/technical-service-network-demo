...
class DemoDataRepo {
    ...
    val categories = listOf(
        ServiceCategory("smart-home", "⌁", "نصب تجهیزات هوشمند", "Smart Home Install", "نصب کلید هوشمند، سنسور، دوربین متصل، قفل دیجیتال و راه اندازی اپلیکیشن.", "Smart switches, sensors, connected cameras, digital locks, and app setup."),
        ServiceCategory("boiler", "♨", "تعمیر پکیج", "Boiler Repair", "عیب یابی پکیج، تنظیم فشار، رسوب گیری، سرویس دوره ای و قطعات مصرفی.", "Boiler diagnostics, pressure tuning, descaling, maintenance, and consumable parts."),
        ServiceCategory("welding", "⚙", "جوشکاری سبک", "Light Welding", "جوشکاری درب و حفاظ سبک، پایه فلزی، تعمیر چارچوب و کارهای سریع ساختمانی.", "Light gates, guards, metal bases, frame repairs, and quick building welding."),
    ...
    val technicians: MutableList<Technician> = mutableListOf(
        technician(25, "پیمان روشنی", "Peyman Roshani", "نصاب خانه هوشمند و تجهیزات متصل", "Smart home and connected device installer", "تهران", "Tehran", "نصب تجهیزات هوشمند", "Smart Home Install", listOf("کلید هوشمند", "سنسور حرکتی", "قفل دیجیتال", "اپلیکیشن"), listOf("smart switches", "motion sensor", "digital lock", "mobile app"), 4.9, 121, true, 4.6, "کمتر از ۳ ساعت", "under 3 hours", 780000, "از ۷۸۰ هزار تومان", "from 780,000 toman"),
        technician(26, "نگین عابدی", "Negin Abedi", "کارشناس راه اندازی تجهیزات هوشمند واحدهای اداری", "Office smart device setup specialist", "قم", "Qom", "نصب تجهیزات هوشمند", "Smart Home Install", listOf("هاب مرکزی", "دوربین متصل", "آموزش کاربر", "سناریوی روشنایی"), listOf("central hub", "connected camera", "user training", "lighting scenes"), 4.6, 68, true, 6.8, "فردا صبح", "tomorrow morning", 690000, "از ۶۹۰ هزار تومان", "from 690,000 toman"),
        technician(27, "آرمان کاویانی", "Arman Kaviani", "تکنسین تعمیر و سرویس پکیج", "Boiler repair and maintenance technician", "قم", "Qom", "تعمیر پکیج", "Boiler Repair", listOf("تنظیم فشار", "رسوب گیری", "عیب یابی برد", "سرویس دوره ای"), listOf("pressure tuning", "descaling", "board diagnostics", "maintenance"), 4.8, 104, true, 5.3, "امروز عصر", "today evening", 610000, "از ۶۱۰ هزار تومان", "from 610,000 toman"),
        technician(28, "فرزانه رادمنش", "Farzaneh Radmanesh", "کارشناس ایمنی و سرویس گرمایش", "Heating safety and service specialist", "کرمان", "Kerman", "تعمیر پکیج", "Boiler Repair", listOf("نشتی گاز", "هواگیری", "تعویض سنسور", "بررسی دودکش"), listOf("gas leak check", "air bleeding", "sensor replacement", "flue inspection"), 4.4, 57, false, 8.1, "تا ۲۴ ساعت", "within 24 hours", 570000, "از ۵۷۰ هزار تومان", "from 570,000 toman"),
        technician(29, "یونس فلاح", "Younes Fallah", "جوشکار سبک درب و حفاظ", "Light gate and guard welder", "اهواز", "Ahvaz", "جوشکاری سبک", "Light Welding", listOf("حفاظ پنجره", "تعمیر درب", "پایه فلزی", "جوشکاری فوری"), listOf("window guard", "door repair", "metal base", "urgent welding"), 4.7, 89, true, 3.9, "کمتر از ۴ ساعت", "under 4 hours", 730000, "از ۷۳۰ هزار تومان", "from 730,000 toman"),
        technician(30, "سمیرا نیکخواه", "Samira Nikkhah", "مجری تعمیرات فلزی سبک", "Light metal repair specialist", "اراک", "Arak", "جوشکاری سبک", "Light Welding", listOf("چهارچوب", "پله سبک", "نرده", "برشکاری"), listOf("frame repair", "light stairs", "railing", "cutting"), 4.3, 46, false, 7.6, "فردا", "tomorrow", 660000, "از ۶۶۰ هزار تومان", "from 660,000 toman"),
        technician(31, "مهدی شریفی", "Mehdi Sharifi", "کاشی کار سرویس و آشپزخانه", "Bathroom and kitchen tile installer", "بندرعباس", "Bandar Abbas", "کاشی و سرامیک", "Tile and Ceramic", listOf("تعویض کاشی", "بندکشی", "شیب بندی", "آب بندی"), listOf("tile replacement", "grouting", "slope leveling", "sealing"), 4.6, 77, true, 6.2, "۲۴ ساعت آینده", "next 24 hours", 760000, "از ۷۶۰ هزار تومان", "from 760,000 toman"),
        technician(32, "رها کیانی", "Raha Kiani", "هماهنگ کننده بازسازی های کوچک", "Small renovation coordinator", "قم", "Qom", "بازسازی و تعمیرات جزئی", "Minor Renovation", listOf("بازدید اولیه", "زمان بندی تیم", "ترمیم دیوار", "هماهنگی مصالح"), listOf("initial visit", "team scheduling", "wall repair", "material planning"), 4.9, 98, true, 4.7, "فردا صبح", "tomorrow morning", 940000, "برآورد پس از بازدید", "estimate after visit"),
        technician(33, "نوید سلطانی", "Navid Soltani", "متخصص شبکه خانگی و اداری", "Home and office network specialist", "اهواز", "Ahvaz", "خدمات شبکه و اینترنت", "Network and Internet", listOf("وای فای مش", "مودم", "کابل کشی", "تست سرعت"), listOf("mesh Wi-Fi", "router", "cabling", "speed test"), 4.7, 83, true, 5.8, "کمتر از ۳ ساعت", "under 3 hours", 410000, "از ۴۱۰ هزار تومان", "from 410,000 toman"),
        technician(34, "الهام شریعتی", "Elham Shariati", "تعمیرکار موبایل و بازیابی اطلاعات", "Mobile repair and data recovery specialist", "کرمان", "Kerman", "تعمیر موبایل", "Mobile Repair", listOf("تعویض باتری", "بازیابی اطلاعات", "تعویض سوکت", "عیب یابی نرم افزار"), listOf("battery replacement", "data recovery", "port replacement", "software diagnostics"), 4.5, 69, true, 6.5, "امروز", "today", 470000, "از ۴۷۰ هزار تومان", "from 470,000 toman"),
        technician(35, "کاوه صفاری", "Kaveh Saffari", "هماهنگ کننده نظافت پس از تعمیرات", "Post-repair cleaning coordinator", "بندرعباس", "Bandar Abbas", "نظافت و خدمات عمومی", "Cleaning Services", listOf("نظافت نهایی", "جمع آوری نخاله سبک", "ضدعفونی", "تیم دو نفره"), listOf("final cleaning", "light debris", "sanitizing", "two-person team"), 4.2, 52, false, 9.4, "تا ۲۴ ساعت", "within 24 hours", 330000, "از ۳۳۰ هزار تومان", "from 330,000 toman"),
        technician(36, "پانیذ موسوی", "Paniz Mousavi", "نصاب شیرآلات و تجهیزات بهداشتی", "Fixture and sanitary equipment installer", "اراک", "Arak", "نصب شیرآلات", "Fixture Install", listOf("شیرآلات", "فلاش تانک", "آب بندی", "دوش"), listOf("fixtures", "flush tank", "sealing", "shower"), 4.8, 87, true, 4.2, "امروز عصر", "today evening", 450000, "از ۴۵۰ هزار تومان", "from 450,000 toman"),
    ...
    private fun sampleReviews(ratingSeed: Double, categoryFa: String): MutableList<Review> {
        ...
        return mutableListOf(
            Review("ساکن مجتمع", support, "هماهنگی از داخل سامانه راحت بود و بعد از پایان کار، توضیح کوتاهی برای نگهداری بهتر داده شد.", now.minusDays(17)),
